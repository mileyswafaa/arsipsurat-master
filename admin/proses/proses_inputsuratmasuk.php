<?php
    ...
    $disposisi3	                        = mysqli_real_escape_string($db,"0");
    ...
    if (!($tgl_masuk=='') and !($kode_suratmasuk =='') and !($nomorurut_suratmasuk  =='') and !($nomor_suratmasuk =='') and !($pengirim =='') and !($perihal_suratmasuk =='') and !($tanggal_entry =='') and ($tipe_file == "application/pdf") and ($ukuran_file <= 10340000)) {		
		...
		$sql = "INSERT INTO tb_suratmasuk(tanggalmasuk_suratmasuk, kode_suratmasuk, nomorurut_suratmasuk, nomor_suratmasuk, tanggalsurat_suratmasuk, pengirim, kepada_suratmasuk, perihal_suratmasuk, file_suratmasuk, operator, tanggal_entry, disposisi1, tanggal_disposisi1, disposisi2, tanggal_disposisi2, disposisi3, tanggal_disposisi3 )
				values ('$tgl_masuk', '$kode_suratmasuk', '$nomorurut_suratmasuk', '$nomor_suratmasuk', NULL, '$pengirim', '$kepada_suratmasuk', '$perihal_suratmasuk', '$nama_baru', '$operator', '$tanggal_entry', '$disposisi1', '$tgl_disp1', '$disposisi2', '$tgl_disp2', '$disposisi3', '$tgl_disp3')";
