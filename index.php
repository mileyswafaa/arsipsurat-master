...
<html lang="en">
  <head>
    ...
    <title>Arsip Surat BPS Kabupaten Lima Puluh Kota</title>
        ...
        <nav class="navbar navbar-default navbar-fixed-top">
          <div class="container">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="#">ARSIP SURAT <span class="logo-dec">BPS Kabupaten Lima Puluh Kota</span></a>
            </div>
        ...
        <div class="container">
          <div class="row">
            <div class="banner-info text-center wow fadeIn delay-05s">
              ...
              <br><br><br>
              <div class="logo">
		            <img src="img/samarinda.png" alt="" width="280"/>
	            </div>
              <h3 class="bnr-sub-title">SISTEM INFORMASI PENGARSIPAN SURAT</h3>
                <h3 class="bnr-sub-title"><span class="logo-dec">BPS Kabupaten Lima Puluh Kota</span></h3>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p class="sub-title pad-bt15">Website ini berguna untuk pengarsipan Surat Masuk dan Surat Keluar di BPS Kabupaten Lima Puluh Kota</p><p>Surat diarsipkan dalam format PDF lalu disesuaikan nomor urutnya.</p>
            <hr class="bottom-line">
            <p class="sub-title pad-bt15">Pengarsipan Surat itu<strong> PENTING</strong> </br>karena dapat menghindari salah komunikasi , mencegah adanya duplikasi pekerjaan </br>dan membantu mencapai efisiensi kerja.</p>
            <hr class="bottom-line">
          </div>
        <div class="col-md-4">
        </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12 portfolio-item padding-right-zero mr-btn-15">
            <figure>
              <img src="img/rifki_new.png" class="img-responsive">
              <figcaption>
                  <h2>KAMILIA WAFA PAKUANI, S.Tr.Stat</h2>
                  <p>PRANATA KOMPUTER AHLI PERTAMA</p>
                  <p>BPS Kabupaten Lima Puluh Kota</p>
                  <br>
                  <p>"If you don't like where you are, Move! You're not a Tree 🌴"</p>
              </figcaption>
            </figure>
          </div>
          <div class="col-md-3"></div>
    ...
    <footer id="footer">
      <div class="container">
        <div class="row text-center">
          <p>&copy; BPS Kabupaten Lima Puluh Kota. All Rights Reserved.</p>
          <div class="credits">
            <!-- 
